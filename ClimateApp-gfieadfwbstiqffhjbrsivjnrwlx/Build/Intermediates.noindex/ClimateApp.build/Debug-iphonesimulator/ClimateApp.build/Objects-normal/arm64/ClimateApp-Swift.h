...
#ifndef CLIMATEAPP_SWIFT_H
#define CLIMATEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ClimateApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10ClimateApp11AppDelegate")
...
SWIFT_CLASS("_TtC10ClimateApp13SceneDelegate")
...
SWIFT_CLASS("_TtC10ClimateApp14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified InputOL;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified outputOL;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageViewOL;
- (void)viewDidLoad;
- (IBAction)submitButtonClicked:(UIButton * _Nonnull)sender;
